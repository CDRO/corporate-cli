# Milestone 04: Lexicon Design

## Goal
Create the vocabulary layer that powers the tool’s transformations.
...
- It may be helpful to separate “harsh” and “replacement” sets, so they are easier to review.
